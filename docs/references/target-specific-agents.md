...
The initial adapter design referenced gentle-ai (see `docs/ape/003-ape-init-v2/analyze/referencia-gentle-ai.md`), which copies skills identically across 11 targets. The assumption was that agents could receive the same treatment.
